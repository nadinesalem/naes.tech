...
<aside class="widget-area" itemscope itemtype="http://schema.org/WPSideBar">
	<?php
	if ( !get_theme_mod( 'brutalistthemes_about_shop_sidebar_setting' ) && ( get_theme_mod( 'brutalistthemes_about_title_setting' ) || get_theme_mod( 'brutalistthemes_about_button_setting' ) || get_theme_mod( 'brutalistthemes_about_text_setting' ) || get_theme_mod( 'brutalistthemes_about_link_setting' ) || get_theme_mod( 'brutalistthemes_about_image_setting' ) ) ) { ?>
